...
<body>
	<div class="container">
		<header>
			<form action="${pageContext.request.contextPath}/BBSController5" method="post">
				<div>
				<c:choose>
					<c:when test="${choice eq '2'}">
						<label for="choice1">홀수월</label>
						<input type="radio" name="choice" id="choice1" value="1">
						<label for="choice2">짝수월</label>
						<input type="radio" name="choice" id="choice2" value="2" checked>
					</c:when>
					<c:otherwise>
						<label for="choice1">홀수월</label>
